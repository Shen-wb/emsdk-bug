...
MainModule.prototype['shenDebug'] = MainModule.prototype.shenDebug = /** @suppress {undefinedVars, duplicate} @this{Object} */function(n) {
  var self = this.ptr;
  if (n && typeof n === 'object') n = n.ptr;
  return _emscripten_bind_MainModule_shenDebug_1(self, n);
};;
